...
# <bitbar.image>https://github.com/noyannus/WhereAmI-Readme/blob/master/Minimalist.png</bitbar.image>
# <bitbar.image>https://github.com/noyannus/WhereAmI-Readme/blob/master/KingSizeInfo.png</bitbar.image>
