...
# <bitbar.title>TaskPaper Todo in Colour</bitbar.title>
# <bitbar.version>v1.0</bitbar.version>
# <bitbar.author>raguay</bitbar.author>
# <bitbar.author.github>raguay</bitbar.author.github>
# <bitbar.desc>Todo list with customizable color-code. Mark tasks "done" simply by clicking on them in the menubar drop-down list.</bitbar.desc>
# <bitbar.dependencies>ruby</bitbar.dependencies>
#
# Change to your todo directory path. This directory should have
# a TaskPaper 3 file named today.txt. This corresponds to my Alfred 3
# todo workflow naming.
#
require 'date'
