...
# <xbar.image>https://github.com/ameyabap/resources/blob/main/960px-World_Time_Zones_Map.svg.png</xbar.image>
# <xbar.dependencies>python3</xbar.dependencies>
# <xbar.abouturl>https://github.com/matryer/xbar-plugins/blob/main/Time/timezone-display.30s.py</xbar.abouturl>
