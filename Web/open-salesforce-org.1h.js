 ...
 * at https://github.com/kacrouse/bitbar-plugin-open-sf-org#readme.
 * 
 * <bitbar.title>Open Salesforce Org</bitbar.title>
 ...
 * <bitbar.desc>Open any Salesforce Org registered with the Salesforce CLI.</bitbar.desc>
 * <bitbar.image>https://github.com/kacrouse/bitbar-plugin-open-sf-org/blob/master/assets/screenshot.png</bitbar.image>
 * <bitbar.dependencies>node,sfdx</bitbar.dependencies>
 * <bitbar.abouturl>https://github.com/kacrouse/bitbar-plugin-open-sf-org#readme</bitbar.abouturl>
 * 
...
const findExecutable = simpleCache(name => child_process.execSync(`which ${name}`, {
  env: { ...process.env,
    PATH: [path.resolve("/usr/local/bin"), process.env.PATH].join(":")
  }
}).toString().trim());

const runCommand = command => child_process.execSync(command).toString();
