...
# <xbar.title>Ripplecoin Ticker ($1USD)</xbar.title>
# <xbar.version>v1.1</xbar.version>
# <xbar.author>impshum</xbar.author>
# <xbar.author.github>impshum</xbar.author.github>
# <xbar.desc>Displays current Ripplecoin price for $1 from Coinmarketcap</xbar.desc>
# <xbar.image>http://i.imgur.com/2xOj6Pu.jpg</xbar.image>
#
# by impshum
...
req = Request('https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?symbol=XRP', None, headers)
data = urlopen(req).read()
result = json.loads(data.decode('utf-8'))

usd = result['data']['XRP'][0]['quote']['USD']
