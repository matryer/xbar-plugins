...
# <xbar.title>Ripplecoin Ticker (£1GBP)</xbar.title>
...
req = Request('https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?symbol=XRP&convert=GBP', None, headers)
data = urlopen(req).read()
result = json.loads(data.decode('utf-8'))

gbp = result['data']['XRP'][0]['quote']['GBP']
