...
# <xbar.title>SurBTC Ticker</xbar.title>
# <xbar.version>v1.0</xbar.version>
# <xbar.author>Agustin Feuerhake</xbar.author>
# <xbar.author.github>agustinf</xbar.author.github>
# <xbar.desc>Shows prices and volume for cryptocurrencies in SurBTC</xbar.desc>
# <xbar.image>https://raw.githubusercontent.com/platanus/surbtc-bitbar-plugin/master/image/image.png</xbar.image>
