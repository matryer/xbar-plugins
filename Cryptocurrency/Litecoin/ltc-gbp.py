...
# <xbar.title>Litecoin Ticker (£1GBP)</xbar.title>
# <xbar.version>v1.1</xbar.version>
# <xbar.author>impshum</xbar.author>
# <xbar.author.github>impshum</xbar.author.github>
# <xbar.desc>Displays current Litecoin price for £1 from Coinmarketcap</xbar.desc>
# <xbar.image>https://i.imgur.com/GUaQ8hZ.jpg/bitbar.image>
#
# by impshum
...
req = Request('https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?symbol=LTC&convert=GBP', None, headers)
data = urlopen(req).read()
result = json.loads(data.decode('utf-8'))

gbp = result['data']['LTC'][0]['quote']['GBP']
