...
# <xbar.title>Liskcoin Ticker ($1USD)</xbar.title>
...
# <xbar.image>https://i.imgur.com/F4UhSWb.jpg</xbar.image>
#
# by impshum
...
req = Request('https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?symbol=LSK', None, headers)
data = urlopen(req).read()
result = json.loads(data.decode('utf-8'))

usd = result['data']['LSK'][0]['quote']['USD']
