...
# <bitbar.image>http://monero.how/images/mac-menu-bar-light-and-dark.jpg</bitbar.image>
# <bitbar.abouturl>http://monero.how</bitbar.abouturl>
#
# Visit http://monero.how for Monero tutorials, paper wallets and the latest Monero news
# 
...
printf '¥%.*f | image=%s | href=http://monero.how/monero-chart\n' 2 $xmrLast $moneroIconBase64
