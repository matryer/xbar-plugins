...
FONT=( 'size=14' 'font=Lucida Grande' )
...
sudo security 2>&1 >/dev/null delete-generic-password -a vpnbook -s $KEYCHAIN_SERV /Library/Keychains/System.keychain
...
sudo security 2>&1 >/dev/null add-generic-password -a vpnbook -l "VPN (PPTP)" -D "Mot de passe PPP" -s $KEYCHAIN_SERV -w $PAGE_PASS -A /Library/Keychains/System.keychain
#echo "----------------"
